        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <form id="demo-form2" action="entrada/editar.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                  <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4">
                    <input type="text" class="form-control has-feedback-left" name="preco_venda" placeholder="Preço Unitário">
                    <span class="fa fa-dollar form-control-feedback left" aria-hidden="true"></span>
                  </div><br><br><br>
                  <div class="col-md-4 col-sm-4">
